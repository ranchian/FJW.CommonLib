...
using FJW.Expression2Sql.Expression2Sql;
...
namespace FJW.Expression2Sql
{
    internal class Expression2SqlProvider
    {
        ...
        internal static void OrderByDescending(Expression expression, SqlBuilder sqlBuilder)
        {
            GetExpression2Sql(expression).OrderByDescending(expression, sqlBuilder);
        }
