...
namespace FJW.Expression2Sql.Expression2Sql
{
    class ParameterExpression2Sql : BaseExpression2Sql<ParameterExpression>
    {
        ...
        protected override SqlBuilder OrderByDescending(ParameterExpression expression, SqlBuilder sqlBuilder)
        {
            Expression2SqlProvider.OrderByDescending(expression, sqlBuilder);
            return sqlBuilder;
        }
