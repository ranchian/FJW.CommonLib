...
namespace FJW.Expression2Sql.Expression2Sql
{
    ...
    {
        public static void OperatorParser(ExpressionType expressionNodeType, int operatorIndex, SqlBuilder sqlBuilder, bool useIs = false)
        {
        ...
        protected override SqlBuilder Where(BinaryExpression expression, SqlBuilder sqlBuilder)
        {
            ...
            //OperatorParser(expression.NodeType, sqlBuilder.Length, sqlBuilder);
